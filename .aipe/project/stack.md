...
| AI SDK | `@anthropic-ai/sdk` 0.91.x (primary), raw fetch to OpenAI |
| FFmpeg | `@wokcito/ffmpeg-kit-react-native` 6.1.2 |
| Secrets | `expo-secure-store` 55.0.9 |
| Fonts | DM Serif Display, DM Mono, Instrument Sans, Nunito (bundled) |

Target platform: Android only. Prebuilt `android/` directory committed; iOS not supported.
