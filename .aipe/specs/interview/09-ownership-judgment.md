...
```
  ...
  by the cloud-sync work — see docs/buffr-cloud-sync-plan.md, M0–M7).
...
The architectural thing I'm most proud of is that the spec docs make all this defensible *without me being in the room*. [`docs/spec.md`](../../../docs/spec.md), [`docs/concepts.md`](../../../docs/concepts.md), and the chapters in this folder all encode the reasoning. A new contributor could read them and understand not just *what* the code does but *why* it's shaped that way. That's the artifact I'd carry forward to any new project.
