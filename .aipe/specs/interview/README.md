...
A book-style defense guide for the buffr codebase. Read in order the first time. Each chapter builds on the previous. After you've read it once, the chapter index doubles as a quick-lookup before specific interviews.
...
| 10 | [Data structures and algorithms](./10-dsa.md) | Three coding problems derived from real buffr ops, with traces |
...
- [docs/spec.md](../../../docs/spec.md) — the canonical architecture reference (what buffr *is*).
